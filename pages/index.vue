<template>
  <div>
      ...
      <section class="relative py-16 px-6 text-center overflow-hidden adinkra-bg">
        ...
        <div class="relative max-w-3xl mx-auto">
          ...
          <div class="flex flex-wrap justify-center gap-4 mt-6">
            <div v-for="[type, color] in legendItems" :key="type" class="flex items-center gap-2 font-mono text-[10px] uppercase tracking-widest text-ink-400">
              <div class="w-2.5 h-2.5 rotate-45" :style="{ background: color }" />
              {{ TYPE_LABELS[type] }}
            </div>
          </div>
        </div>
      ...
      <section class="relative py-16 px-6 text-center overflow-hidden adinkra-bg">
        ...
        <div class="relative max-w-3xl mx-auto">
          ...
          <p class="mt-4 text-ink-400 text-sm max-w-lg mx-auto leading-relaxed">
            ...
            Clique no <strong class="text-gold-400">＋</strong> do item e coloque seu nome e a quantidade.
          </p>
        </div>
      </section>
      <div class="kente" />
    ...
    <!-- DEMAIS ABAS — em construção (ocultas até o site estar pronto) -->
    <!-- <div v-show="currentTab === 'home'"><AppHero />...</div> -->
  </div>
</template>
...
const legendItems = [
  ['gira',           '#D4A017'],
  ['evento',         '#2e7d8c'],
  ['desenvolvimento','#6b4c9e'],
]

// Apenas as abas visíveis por enquanto
// 🔧 Quando o site estiver pronto, adicione as outras abas aqui
const visibleTabs = [
