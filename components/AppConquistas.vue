<template>
  <section id="conquistas" class="py-24 md:py-32 bg-white dark:bg-ink-900">
    <div class="max-w-7xl mx-auto px-6 md:px-10">
      ...
      <div class="mb-16 md:mb-20">
        ...
        <h2 class="font-serif text-4xl md:text-5xl lg:text-6xl font-black text-ink-900 dark:text-white leading-tight">
          Nossas<br>
      ...
      <div class="space-y-0">
        <div
          ...
          :key="acao.id"
          class="group grid grid-cols-1 md:grid-cols-2 border-t border-ink-100 dark:border-ink-800 hover:bg-ink-50 dark:hover:bg-ink-800/50 transition-colors duration-300"
        ...
        >
          ...
          >
            ...
            <div
              ...
              :class="acao.bg"
            >
              <span class="text-ink-400 dark:text-ink-500 text-sm uppercase tracking-widest">{{ acao.titulo }}</span>
            </div>
          </div>
          ...
          >
            ...
            <h3 class="font-serif text-2xl md:text-3xl font-bold text-ink-900 dark:text-white mb-4">
              {{ acao.titulo }}
            </h3>
            ...
            <div>
              ...
              <Transition name="accordion">
                <div v-if="expanded === acao.id" class="overflow-hidden">
                  <p class="text-ink-600 dark:text-ink-300 leading-relaxed text-sm md:text-base pb-4">
                    {{ acao.descricao }}
                  </p>
                </div>
              </Transition>
